          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url() ?>c_inseminasi/tambahInseminasi" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group <?php echo form_error('asalSperma') ? 'has-error' : null ?>">
                  <label for="asalSperma">Asal Sperma</label>
                  <input type="text" id="asalSperma" name="asalSperma" class="form-control">
                  <span class="help-block" style="color: red"><?php echo form_error('asalSperma') ?></span>
                </div>
                ...
                <div class="form-group <?php echo form_error('tglInseminasi') ? 'has-error' : null ?>">
                  <label for="tglInseminasi">Tanggal Inseminasi</label>
                  <input type="date" name="tglInseminasi" id="tglInseminasi" class="form-control">
                  <span class="help-block" style="color: red"><?php echo form_error('tglInseminasi') ?></span>
                </div>
