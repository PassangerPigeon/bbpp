...
<head>
  ...
  <title>BBPP</title>
  <link rel="icon" href="<?php echo base_url() ?>assets/img/banner.png" sizes="40x40">
...
} elseif ($this->uri->segment(2) != "ceklogin" && $this->uri->segment(2) != "logout" && $this->uri->segment(2) != "loginPage" && $this->uri->segment(1) != "" && $this->uri->segment(2) != "auth_login" && $this->uri->segment(2) != "auth_forgot_password" && $this->uri->segment(2) != "auth_register" && $this->uri->segment(2) != "auth_reset_password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
